...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="stok_kendaraan.php"><i class="fa fa-truck"></i> Stok Kendaraan</a></li>
            <li><a href="penyewaan.php"><i class="fa fa-handshake-o"></i> Transaksi Penyewaan</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="kendaraan_inventaris.php"><i class="fa fa-car"></i> Kendaraan Inventaris</a></li>
            <li><a href="member.php"><i class="fa fa-id-card"></i> Member</a></li>
            <li><a href="pengembalian.php"><i class="fa fa-refresh"></i> Pengembalian</a></li>
            <li><a href="pengeluaran.php"><i class="fa fa-area-chart"></i> Pengeluaran</a></li>
            <li><a href="pemasukan.php"><i class="fa fa-line-chart"></i> Pemasukan</a></li>
          </ul>
        </li>
        <li><a href="laporan.php"><i class="fa fa-check-square"></i> <span>Laporan Bulanan</span></a></li>
                    ...
                    <div class="box-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="info-box">
                            <a href="kendaraan_inventaris.php"><span class="info-box-icon bg-yellow"><i class="fa fa-car"></i></span></a>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="info-box">
                            <a href="member.php"><span class="info-box-icon bg-blue"><i class="fa fa-id-card"></i></span></a>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="info-box">
                            <a href="stok_kendaraan.php"><span class="info-box-icon bg-purple"><i class="fa fa-truck"></i></span></a>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="info-box">
                            <a href="penyewaan.php"><span class="info-box-icon bg-green"><i class="fa fa-handshake-o"></i></span></a>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="info-box">
                            <a href="pengembalian.php"><span class="info-box-icon bg-blue"><i class="fa fa-refresh"></i></span></a>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="info-box">
                            <a href="laporan.php"><span class="info-box-icon bg-yellow"><i class="fa fa-book"></i></span></a>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="info-box">
                            <a href="pengeluaran.php"><span class="info-box-icon bg-red"><i class="fa fa-area-chart"></i></span></a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="index.php">J3D118107 Farrel Amadeo Reinhardt Rahmawan</a>.</strong> All rights
    reserved.
  </footer>
